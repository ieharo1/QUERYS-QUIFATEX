...
SELECT * FROM TBL_REGISTRO WHERE REG_IDENTIFICACION = '0401532296';
...
SELECT * FROM TBL_TIMBRE WHERE TIM_IDENTIFICACION = '1003094685' ORDER BY TIM_FECHA_IN ASC;

SELECT * FROM TBL_TIMBRE ORDER BY TIM_IDENTIFICACION, TIM_FECHA_IN, TIM_ESTADO ASC;

SELECT * FROM TBL_REGISTRO WHERE REG_IDENTIFICACION = '0201306479';
